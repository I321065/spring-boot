...
public class RSAUtil {
     ...
     * </p>
     *
     * @param encryptedData 已加密数据 Base64
     * @param publicKey 公钥(BASE64编码)
     * @return
     * @throws Exception
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String bb = new String(decryptByPrivateKey(bytes, pair.get(publickey)));

        //System.out.println(bb);



        //System.out.print(temp.equals(Base64Util.encodeByte(decryptByPrivateKey(Base64Util.decodeString(aa), pair.keySet().iterator().next()))));
